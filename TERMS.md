...
- **Refunds:** Refund requests are handled by Apple per their App Store policies.
- **Price changes:** We may change subscription prices. You will be notified before any price increase takes effect.
...
If you link with a coach, you grant them access to view your recovery scores, workload trends, workout summaries, and wellness check-in ratings. You can unlink from a coach at any time, which revokes their access to your data.

Coaches who log workouts on behalf of athletes do so with attribution. Coaches are responsible for using the platform in good faith.
...
The app, including its design, code, and content, is owned by Hanwen Ma. Your use of the app does not grant you any ownership rights.
...
To the maximum extent permitted by law, we are not liable for any indirect, incidental, or consequential damages arising from your use of the app. Our total liability is limited to the amount you paid for the app in the 12 months preceding the claim.
...
We may update these Terms from time to time. Changes will be posted to this page with an updated date. Continued use of the app after changes constitutes acceptance.
