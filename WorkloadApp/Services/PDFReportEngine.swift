...
struct PDFReportEngine {
    ...
    private static func fontRegular(_ size: CGFloat) -> UIFont {
        UIFont(name: "GeneralSans-Regular", size: size) ?? .systemFont(ofSize: size)
    }

    private static func fontMedium(_ size: CGFloat) -> UIFont {
        UIFont(name: "GeneralSans-Medium", size: size) ?? .systemFont(ofSize: size, weight: .medium)
    }
    ...
    private static func drawHeader(context: CGContext, title: String, subtitle: String) {
        // "Tuwa" wordmark top-left
        drawText("Tuwa", in: CGRect(x: marginH, y: marginV, width: 200, height: 24), font: fontMedium(15), color: textPrimary)
    ...
    private static func drawFooter(context: CGContext, pageNumber: Int) {
        ...
        drawText("Generated by Tuwa", in: CGRect(x: marginH + 100, y: footerY + 4, width: contentWidth - 100, height: 20), font: fontRegular(11), color: textSecondary, alignment: .right)
    }
