...
struct PDFReportEngine {
    ...
    private static func drawHeader(context: CGContext, title: String, subtitle: String) {
        // "Tonus" wordmark top-left
        drawText("Tonus", in: CGRect(x: marginH, y: marginV, width: 200, height: 24), font: fontMedium(15), color: textPrimary)
    ...
    private static func drawFooter(context: CGContext, pageNumber: Int) {
        ...
        drawText("Generated by Tonus", in: CGRect(x: marginH + 100, y: footerY + 4, width: contentWidth - 100, height: 20), font: fontRegular(11), color: textSecondary, alignment: .right)
    }
